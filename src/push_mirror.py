...
def push_mirror(mirror_name: str, project_name: str, commit: str):
    actions = [(["git", "-C", f"{project_name}/{mirror_name}/", "add", "."], "No add can be done"),
               (["git", "-C", f"{project_name}/{mirror_name}/", "commit", "-m", commit], "No commit can be done"),
               (["git", "-C", f"{project_name}/{mirror_name}/", "push"], "No push can be done")]
